...
public class TexCommandContainer {
    ...
    public static final TexCommandEntry[] builtIn = {
            ...
            new TexCommandEntry("dotfill", "\\em\n\nProduces a rubber length that produces dots instead of just spaces.", 0),
            ...
            new TexCommandEntry("hfill", "\\hfill\n\nProduces a rubber length which can stretch or shrink horizontally. It will be filled with spaces.", 0),
            ...
            new TexCommandEntry("hrulefill", "\\hrulefill\n\nProduces a rubber length which can stretch or shrink horizontally. It will be filled with a horizontal rule.", 0),
            new TexCommandEntry("hspace", "\\hspace[*]{length}\n\nAdds horizontal space. The length of the space can be expressed in any terms that LaTeX understands, i.e., points, inches, etc. You can add negative as well as positive space with a \\hspace command.\nLaTeX removes horizontal space that comes at the begining of a line. If you don't want LaTeX to remove this space, include the optional * argument. Then the space is never removed.", 1),
            ...
            new TexCommandEntry("mathrm", "\\mathrm{}\n\nNormal upright Roman math font.", 1),
            new TexCommandEntry("mathnormal", "\\mathnormal{}\n\nNormal italic math font.", 1),
            new TexCommandEntry("mathcal", "\\mathrm{}\n\nSpecial calligraphic math font for uppercase letters only.", 1),
            new TexCommandEntry("mathbf", "\\mathrm{}\n\nUpright Roman boldface math font.", 1),
            new TexCommandEntry("mathsf", "\\mathsf{}\n\nUpright sans serif math font.", 1),
            new TexCommandEntry("mathit", "\\mathsf{}\n\nText italic font.", 1),
            new TexCommandEntry("mathtt", "\\mathsf{}\n\nUpright typewriter type font.", 1),
            new TexCommandEntry("mdseries", "\\mdseries\n\nStarts using a medium-weight font.", 0),
            new TexCommandEntry("medskip", "\\medskip\n\nEquivalent to \\vspace{\\medskipamount} where \\medskipamount is determined by the document style.", 0),
            ...
            new TexCommandEntry("smallskip", "\\smallskip\n\nEquivalent to \\vspace{\\smallskipamount} where \\smallskipamount is determined by the document style.", 0),
